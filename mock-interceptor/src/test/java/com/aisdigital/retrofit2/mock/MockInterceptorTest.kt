package com.aisdigital.retrofit2.mock

import android.content.Context
import com.aisdigital.retrofit2.mock.testutil.SynchronousExecutorService
...
class RetrofitMockTest {
    ...
    private fun initClient(dispatcher: Dispatcher): OkHttpClient.Builder {
        ...
        httpClient.connectTimeout(RetrofitMockTest.TIMEOUT, TimeUnit.SECONDS)
        httpClient.readTimeout(RetrofitMockTest.TIMEOUT, TimeUnit.SECONDS)
        httpClient.writeTimeout(RetrofitMockTest.TIMEOUT, TimeUnit.SECONDS)
        return httpClient
    }
    ...
    fun testRequestPostEmailResponseSuccess() {
        ...
        val requestCall = retrofitTestAPI.requestPostEmailResponse(RetrofitRequest("test@gmail.com"))
    ...
    fun testRequestPostEmailResponseFail() {
        val retrofitTestAPI = retrofit.create(RetrofitTestAPI::class.java)
        val requestCall = retrofitTestAPI.requestPostEmailResponse(RetrofitRequest("testFail@gmail.com"))
    ...
    fun testRequestPostEmailServerError() {
        val retrofitTestAPI = retrofit.create(RetrofitTestAPI::class.java)
        val requestCall = retrofitTestAPI.requestPostEmailResponse(RetrofitRequest("testServerError@gmail.com"))
